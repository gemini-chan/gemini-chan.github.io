...
describe('SettingsMenu NPU temperature initialization', () => {
  ...
  it('falls back to default when temperature is invalid', () => {
    ...
    const temp = (menu as unknown as { [key: string]: unknown })
      ._npuTemperature as number
