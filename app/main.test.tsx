...
describe('main component', () => {
  ...
  beforeEach(async () => {
    ...
    mockSessionManager.textTranscript = [
      { text: 'Hello! How can I help you?', speaker: 'model' },
    ]
  ...
  it('should display a user message after sending', async () => {
    ...
    const chatView = mainComponent.shadowRoot?.querySelector(
      'chat-view'
    ) as ChatView
    ...
    const sendButton = chatView?.shadowRoot?.querySelector(
